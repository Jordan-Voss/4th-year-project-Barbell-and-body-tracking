...
userImageInput = r"../../static/img/front.png"
print(userImageInput)

img = r"../../static/img/White.jpg"
...
for i in dictAngle:
    ...
    if str(dictPoint1) != 'None' and str(dictPoint2) != 'None' and str(dictPoint3) != 'None':
        ...
        cv2.putText(frameWhite, str(ang1), pointAngle, cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2, cv2.LINE_AA)
...
athletesOutputFirst = r"output_1.jpg"
athletesOutputSecond = r"output_2.jpg"
cv2.imwrite(athletesOutputSecond, frameWhite)
cv2.imwrite(athletesOutputFirst, frame)
